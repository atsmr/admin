            ...
            return (
                <div class={this.state.disabled ? style.editableList : style.editableListFocus} onclick={this.editableListClick}>
                    <div class={style.wrap}>
                        ...
                        <div class={style.title}><input id='mainInput' data-key={this.props.dataKey} data-index={this.props.dataIndex} key={this.props.key} ref={c => {this.refs=c} } type="text" placeholder={'Write a task name'} onkeydown={this.props.onkeydown} disabled={this.state.disabled} onblur={this.onBlur}/></div>
